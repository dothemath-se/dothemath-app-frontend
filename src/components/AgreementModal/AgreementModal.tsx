...
export const CookiePolicyModal = (props: AgreementModalProps) => (
...
export const PrivacyPolicyModal = (props: AgreementModalProps) => (
  <AgreementModal {...props}>
    <div>
      <p>Stockholm</p>
      <p>2020-05-07</p>
      ...
      <p>
        ...
        till att du har glädje av vår tjänst. För att göra detta behöver vi
        lagra viss information om dig, så att vi kan göra din upplevelse
        personlig, men också möjliggöra för oss att på ett effektivt sätt ge dig
        ett så bra svar som möjligt. Integritet och skydd av dina
        personuppgifter är, och kommer att förbli, enormt viktig för oss. Därför
        vill vi på ett transparent sätt beskriva hur vi samlar in, lagrar, delar
        och behandlar dina personuppgifter samt beskriva dina val- och
        kontrollmöjligheter kring när och hur du väljer att dela dina
        personuppgifter. Denna integritetspolicy förklarar mer detaljerat vad vi
        menar, och syftet med den är att:
      </p>
      <ul>
        <li>
        ...
        <li>
          Förklara på vilket sätt vi behandlar de personuppgifter som du delar
          med oss för att ge dig en bra upplevelse när du använder
          DoTheMath-tjänsten; och
        </li>
        <li>
      ...
      <p>
        ...
        övertygelse, medlemskap i fackförening samt personuppgifter som rör
        hälsa eller sexualliv. Uppgifter om hälsa kan vara till exempel
        sjukfrånvaro, graviditet och läkarbesök.
      </p>
      ...
      <p>
        ...
        organisationen som på uppdrag av den personuppgiftsansvarige får
        behandla personuppgifter, dock endast i enlighet med instruktioner från
        denne. Ett skriftligt avtal som reglerar förhållandet mellan
        personuppgiftsbiträdet och den personuppgiftsansvarige måste finnas där
        säkerhetsåtgärderna vid behandlingen av personuppgifter regleras.
      </p>
      ...
      <ul>
        <li>
          Rätt till tillgång - rätten att informeras om, och begära tillgång
          till, de personuppgifter som vi behandlar om dig, och hur de
          behandlas.
        </li>
        <li>
        ...
        <li>
          ...
          personuppgifter när alla förpliktelser är uppfyllda så som till
          exempel skulder betalda.
        </li>
        <li>
        ...
        <li>
          Rätt att inte bli föremål för automatiserat beslutsfattande - rätten
          att inte bli föremål för några beslut som grundas enbart på
          automatiserat beslutsfattande, inklusive profilering, där beslut
          skulle medföra rättsliga följder för dig eller annan påverkan av
          liknande karaktär.
        </li>
      </ul>

      <p>
        Slutligen har du även rätt att lämna in ett klagomål till
        Datainspektionen med avseende på vår behandling av dina personuppgifter.
        Du når dem på +46 8 657 61 00,{' '}
      ...
      <ol>
          ...
          <ol type="a">
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      Identifierare som kan innefatta cookiedata och
                      IP-adresser, operativsystem samt webbläsare
                    </li>
            ...
            <li>
              ...
              <p>
                ...
                e-postadress, beroende på kontaktform, samt övriga
                personuppgifter som krävs för att kunna assistera den som
                kontaktar oss.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Vid användning av tjänsten samlar Företaget in uppgifter genom
                så kallade cookies. Mer information finns i vår cookie policy.
                Vid besök på Företagets webbplats eller vid användning av
                tjänsten samlas följande data in genom cookies: trafikdata,
                IP-adress, typ av enhet, operativsystem och webbläsartyp som
                besökaren använder.
              </p>
            </li>
          </ol>
        ...
        <li>
          ...
          <p>
            ...
            att vi ska kunna tillhandahålla tjänsten. DoTheMath använder
            följande underleverantörer eller kategorier av underleverantörer:
          </p>
          ...
          <p>
            ...
            polis, skattemyndigheter eller andra myndigheter om vi är skyldigt
        ...
        <li>
          ...
          <p>
            ...
            våra rättsliga förpliktelser och för att kunna lösa tvister. Vi
            sparar vissa av dina personuppgifter under den tid du använder
            tjänsten, dock inte längre än 90 dagar efter ditt sista användande
          </p>
          <p>
            På din begäran tar vi bort eller anonymiserar dina personuppgifter
            så att de inte längre identifierar dig, såvida vi inte är rättsligt
            berättigade eller skyldiga att behålla vissa personuppgifter, såsom
            vid följande situationer:
          </p>
          <ul>
            <li>
              Om det finns ett olöst problem hänförligt till ditt konto, såsom
              en utestående kredit avseende ditt konto, ett utestående krav
              eller vid tvist, kommer vi att spara nödvändiga personuppgifter
            ...
            <li>
              ...
              personuppgift, kommer vi att lagra nödvändiga personuppgifter
              under den tidsperiod som görs gällande i tillämplig lagstiftning
            </li>
            <li>
      ...
      <p>
        ...
        inrapportera till integritetsskyddsmyndigheten inom 72 timmar. Om det
        inte är osannolikt att brukaren av tjänsten riskerar att ta skada är
        nationen skyldig att informera de registrerade så de kan vidta
        nödvändiga åtgärder.
      </p>
      ...
      <p>
        ...
        ändras. Om väsentliga ändringar i texten görs kommer vi att meddela dig
        senast 30 dagar innan ändringen träder i kraft genom tjänsten eller
        genom att publicera en ny version på vår webbplats; dothemath.se. Se
        till att du läser sådana meddelanden noggrant.
      </p>

      <h2>7. Kontakt</h2>
      <p>
        Vid synpunkter eller frågor avseende vår integritetspolicy, olösta
        problem avseende integritet och användning av personuppgifter som vi
        inte har hanterat på ett tillfredsställande sätt, eller avseende
        eventuella överträdelser som rör din integritet, kan du kontakta oss via
        vår e-mailadress;{' '}
        <a href="mailto:privacy@dothemath.se">privacy@dothemath.se</a>.
      </p>
...
export const UserAgreementModal = (props: AgreementModalProps) => (
  <AgreementModal {...props}>
    <div>
